...
════════════════════════ */
const AUTHORS_DATA = [
  { id:'a1', realName:'Rivan Khalid',  penName:'R. Khalid', photo:'https://picsum.photos/seed/auth1/200/200', bio:'Komikus visioner yang terinspirasi sains fiksi klasik. Setiap panel karyanya seperti foto dari galaksi yang belum pernah ada.', rating:{ average:4.7, votes:180 } },
  { id:'a2', realName:'Nadia Surya',   penName:'Nadia S.',   photo:'https://picsum.photos/seed/auth2/200/200', bio:'Novelis dengan kepekaan emosional luar biasa. Karyanya hidup dari detail kecil yang orang lain lewatkan.', rating:{ average:4.9, votes:320 } },
  { id:'a3', realName:'Dimas Pratama', penName:'D. Prata',   photo:'https://picsum.photos/seed/auth3/200/200', bio:'Maestro cyberpunk Indonesia. Worldbuilding-nya rapi, action-nya membara, linework-nya tak tertandingi.', rating:{ average:4.5, votes:210 } }
];
...
const STORIES_DATA = [
  ...
  },
  {
    ...
    music:{ enabled:true, playlist:['https://open.spotify.com/embed/track/7q4zdBAgLFETdnslE7Z0Eq?utm_source=generator'] },
    chapters:[
  ...
  {
    id:'4', title:'Petrichor', type:'novel',
    ...
    chapters:[
      { id:'ch1', title:'Day 1 — Kilometer Zero', date:'2024-10-15', content:"Hana's journal. Day one.\n\nI don't know why I agreed to this. I know why — Mama asked, and you don't say no when Mama uses that tone. But I don't know why I agreed in my heart.\n\nFarhan was waiting outside the apartment at six-fifteen. Always fifteen minutes early. His car is blue. I didn't know that. I don't know a lot of things about him anymore.\n\nWe didn't say anything for almost two hours.\n\nHe played music I didn't recognize. That felt like a whole conversation I wasn't ready to have.\n\nWe stopped for gas outside Bogor. I got out and stretched, and the morning smelled like petrichor — that smell after rain, when the earth has absorbed it and is giving it back. He taught me that word, fifteen years ago.\n\nHe came back with two coffees. Set one on the roof of the car near me. 'Thank you.' He said, 'Long drive.' I said, 'Yeah.'\n\nThree thousand kilometers to go." },
      { id:'ch2', title:'Day 3 — Somewhere in Lampung', date:'2024-10-17', content:"Hana's journal. Day three.\n\nWe had our first real conversation today. Which I think means our first real argument.\n\nIt started over the map. Somewhere south of Bandar Lampung the signal dropped and he pulled over. He said, 'Why did you bring a paper map, it's not 2003,' and I gestured at his phone, which had no signal.\n\nHe was quiet, then said: 'Okay, fair.'\n\nI don't know why that made me want to cry.\n\nWe read the map together. His finger on the page, mine on the page, almost touching.\n\n'There's a coastal road,' I said. 'Longer but—' 'Prettier,' he finished.\n\nWe used to do that.\n\nWe took the coastal road. The sea on our right was green and bright and enormous.\n\nHe said, quietly: 'I missed you.' I said: 'I know.'\n\nMaybe that's enough for day three." }
    ]
  },
  {
